{
	...
	// Whether to ignore the built-in default auto-approve rules used by the run in terminal tool as defined in `chat.tools.terminal.autoApprove`. Setting to false will disable any rule that comes from the default set, enabling only rules from user, remote and workspace settings. Use this at your own risk, the default denial rules are designed to protect you against running dangerous commands.
	...
	//  - none: No tool calls are added into the collapsible thinking section.
	//  - all: All tool calls are added into the collapsible thinking section.
	//  - readOnly: Only read-only tool calls are added into the collapsible thinking section.
	"chat.agent.thinking.collapsedTools": "readOnly",
